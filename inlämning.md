...
Kvartersbion är ett fullstack-biografbokningssystem byggt med React och TS i frontend samt C# i backend, kopplat till en MySQL moln databas.
...
En brist var att tillslut eftermånga försök och mail så fick vi göra en sandbox mail i mailtrap, jag fick mitt google nummer spärrat och en annan medlem i våran grupp med. Outlook har ändrat sina regler
och det går inte att ha SMTP mail som privat person längre, efter 2,5 dagar sammanlagt för att fixa valde vi att ha mailtrap för att inte spendera med resurser på mailen.
...
Konstrueringen ser väldigt gedigen ut och som mitt första projekt i denna skala tycker jag inte det är något mycket mer som jag skulle vilja göra annorlunda, är väldigt stolt över hur hela projektet och inlärnings processen har flödat. Kan verkligen lägga stort märke till hur min kunskapskurva har börjat accelerera, jag kan delta i diskussioner, ha åsikter och synpunkter över hur jag anser är det bästa
sätter att föra ihop logik och / eller flöde.
Lärdom i kod var exponentiellt större i detta projekt, det magiska är som jag beskrev ovan är att jag har börjat förstå, kunna förklara vad som händer gå tillbaka förklara och på så sätt ger det mig
en ännu djupare kunskap.

En ny funktionalitet hade kunnat vara admin del och den nya del 25 av backlogen.
Det hade behövts implementera admin del i databasen, vilket vi redan har dock hade det behövts ny logik i både backend och frontend.
...
steg 5 bestämma - knyter vi en tråd i taget och lämar allt "rough" och sedan gör css eller göra som vi gjorde? En gedigen mockup som redan såg ut som en sida och sedan implementera backend?
...
DOCK - är nyfiken på att bara göra allting riktig rått, utan css göra alla api anrop, login, knyta en knut i taget och se hur det går till!
